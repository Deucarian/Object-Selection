# Deucarian Object Selection Agent Notes

Package ID: `com.deucarian.object-selection`
Repository: `Deucarian/Object-Selection`
...
- World-object selection, hover tracking, raycast adapters, and highlight hooks.
...
- Core State synchronization, UI binding, API/session behavior, or generic selection state primitives.

## Dependencies

Allowed dependency shape:

- May depend on Logging and Unity Physics module it directly uses.
...
- Common: Do not add Common unless production code directly owns transient Unity cleanup.
- Editor UI: No editor shell ownership.
- Diagnostics: No diagnostics ownership.
- Testing: Tests should cover world selection behavior; Core State sync belongs in the integration package.
